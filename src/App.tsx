...
export function App() {
  ...
  const handleSplashNavigate = (view: string) => {
    if (view === 'vscan') {
      setShowScanner(true);
      return;
    }
  ...
  if (showSplash) return <SplashPage onEnter={() => setShowSplash(false)} onNavigateToView={handleSplashNavigate} />;
