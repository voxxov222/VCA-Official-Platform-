...
export const BREAKING_NEWS_ITEMS = [
  { id: '1', text: '🟢 CHARIZARD BASE SET 1ST ED PSA 10 SURGES +14.8% TO $9,850 CAD FOLLOWING JAPAN AUCTION RECORD', type: 'price_up' },
  { id: '2', text: '🟣 VCA MINTS SERIAL VCA-000-000-001 — NTAG424 DNA NFC SEAL VERIFIED INT-OK', type: 'grading' },
  { id: '3', text: '🟡 LIVE AUCTION: 2023 PIKACHU ILLUSTRATION RARE #173 VCA 10 GEM MINT ENDING IN 18 HOURS', type: 'auction' },
  { id: '4', text: '⚪ VSCAN AI V2.4 NEURAL VISION ENGINE ONLINE: SUPPORTING MULTI-CARD ISOLATION & VARIANTS', type: 'news' }
];
